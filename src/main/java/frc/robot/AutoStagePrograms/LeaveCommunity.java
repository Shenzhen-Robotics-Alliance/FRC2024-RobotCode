...
public class LeaveCommunity implements CommandSequenceGenerator {
    ...
    public List<SequentialCommandSegment> getCommandSegments(RobotCore robotCore) {
        ...
        commandSegments.add(commandFactory.moveFromPointToPoint(new Vector2D(new double[] {0, 0.4}), new Vector2D(new double[] {0, 3}), new Rotation2D(0), new Rotation2D(Math.PI)));
