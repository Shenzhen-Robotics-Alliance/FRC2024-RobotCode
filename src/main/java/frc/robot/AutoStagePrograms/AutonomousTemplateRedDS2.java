...
public class AutonomousTemplateRedDS2 implements AutoStageProgram {
    public static final Vector2D startingPosition = new Vector2D(new double[] {0, 0.4}),
            ...
            position3 = new Vector2D(new double[] {1.2, 2.5}),
            ...
            position8 = RedDS2.midLineLefterNotePosition.addBy(new Vector2D(new double[] {0.5, -0.3})),
            position10 = new Vector2D(new double[] {1, 1.5}),
            position11 = new Vector2D(new double[] {1.8, 1.8}),
